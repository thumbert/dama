...
double cPhi(num x) {
  ...
  int j = i;
  final List<double> R = [1.25331413731550025, 0.421369229288054473, 0.236652382913560671,
  0.162377660896867462, .123131963257932296,0.0990285964717319214,
  0.0827662865013691773,.0710695805388521071,0.0622586659950261958];
  double pwr=1.0, a=R[j], z=2.0*j, b=a*z-1,h=x.abs()-z,s=a+h*b,t=a,q=h*h;
  for(i=2; s!=t; i+=2){
    a = (a+z*b)/i;
    b = (b+z*a)/(i+1);
    pwr *= q;
  ...
  if (x>=0)  return s; else return (1.0 - s);
}